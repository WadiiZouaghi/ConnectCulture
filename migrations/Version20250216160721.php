 ...
 */
final class Version20250216160721 extends AbstractMigration
{
    ...
    {
        // Modify the table name to use backticks to avoid issues with the reserved keyword "groups"
        $this->addSql('CREATE TABLE `groups` (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, event_date DATETIME DEFAULT NULL, location VARCHAR(255) DEFAULT NULL, max_group_size INT DEFAULT NULL, contact VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
